 ...
 */
public class Form100Dss extends ActionBarActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener {
    MSession session;
    ...
    private int key;
    DssDetailsDb babyDetailsDb;
    DssDetailsDb motherDetailsDb;
    ...
    MaterialEditText txtReferralFacility, txtformSerial, txtPatientID, txtPatientName, txtPatientAge
            , txtReferralReason, txtTreatment, txtComments, materialEditText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // set this values from databases of Mother or babyActivity
        ...
        switch (key){
            case  1:
                babyDetailsDb = DssDetailsDb.getInstance(getApplicationContext());
                BabyModel babyModel = babyDetailsDb.getAllBaby();
                ...
                spnSublocation2.setSelection(3);
                spnVillage.setSelection(3);

                break;
            case 2:
                babyDetailsDb = DssDetailsDb.getInstance(getApplicationContext());
                BabyModel babyModel2 = babyDetailsDb.getAllBaby();
                txtformSerial.setText(babyModel2.getClient_rand().trim());
                ...
                break;
            case 3:
                motherDetailsDb = DssDetailsDb.getInstance(getApplicationContext());
                MotherModel motherModel = motherDetailsDb.getMotherDetails();
                txtformSerial.setText(motherModel.getClient_rand());
                txtPatientName.setText(motherModel.getClient_name());
                txtPatientAge.setText(motherModel.getClient_age());
                //rgGender.check(motherModel.getClient_gender());
                spnSublocation2.setSelection(3);
                spnVillage.setSelection(3);
                break;
            case 4:
                motherDetailsDb = DssDetailsDb.getInstance(getApplicationContext());
                MotherModel motherModel2 = motherDetailsDb.getMotherDetails();
                txtformSerial.setText(motherModel2.getClient_rand());
                txtPatientName.setText(motherModel2.getClient_name());
                txtPatientAge.setText(motherModel2.getClient_age());
                spnSublocation2.setSelection(3);
                spnVillage.setSelection(3);
                break;
    ...
    //Offline storage-locaion-sublocation
    private void getLocalArea() throws JSONException {

        LocationDb communityUnitDb = LocationDb.getInstance(this);
    ...
    void validate(){
        ...
        /*if(refFacility != null){
            if(refFacility.equals("OTHERS")){
                ...
                if(referralUnit.equals("")){
                    Toast.makeText(Form100Dss.this, "Enter a referral Unit", Toast.LENGTH_LONG).show();
            ...
            Toast.makeText(Form100Dss.this, "Select Referral Health Facility", Toast.LENGTH_LONG).show();
        ...
        if(linkFacilityId == null){
            Toast.makeText(Form100Dss.this, "Select Link Health Facility", Toast.LENGTH_LONG).show();
            spnLinkFacility.requestFocus(); ok = false; return;
        }
        ...
        if(villageId == null || villageId < 0){
            Toast.makeText(Form100Dss.this, "Select Community Unit", Toast.LENGTH_LONG).show();
            spnVillage.requestFocus(); ok = false; return;
        }
        if(category == 0){
            Toast.makeText(Form100Dss.this, "Select Patients status", Toast.LENGTH_LONG).show();
    ...
    public void getUniqueKey(final Context context, String uniqueKey){
        final ProgressDialog pDialog = new ProgressDialog(Form100Dss.this);
                ...
                new Response.Listener<JSONObject>() {
                    public void onResponse(JSONObject response) {
                        ...
                        if(success.isSuccess()){
                            Crouton.makeText(Form100Dss.this , success.getMessage() , Style.CONFIRM).show();
                ...
                new Response.Listener<JSONObject>() {
                    public void onResponse(JSONObject response) {
                        ...
                        if(success.isSuccess()){
                            ...
                            Crouton.makeText(Form100Dss.this , success.getMessage() , Style.ALERT).show();
                        }
                    };
                } ,
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Log.e(MApplication.TAG, error.toString());
                        MUtil.hideProgressDialog(pDialog);
                        Crouton.makeText(Form100Dss.this, VolleyErrorHelper.getMessage("Offline mode", context), Style.ALERT).show();
                        getTotal();
                    }
                }){
        };
    ...
    private void getTotal() {
        ...
        SharedPreference shred = new SharedPreference();

        int postpartum = shred.getValue(getApplicationContext(), "postpartum");
        int pregnant = shred.getValue(getApplicationContext(), "pregnant");
        int children = shred.getValue(getApplicationContext(), "children");
        int infant = shred.getValue(getApplicationContext(), "infant");
        int other_mothers = shred.getValue(getApplicationContext(), "other_mothers");
        int other_members = shred.getValue(getApplicationContext(), "other_mothers");
    ...
    public void showDescription(View v) {
        ...
        new SweetAlertDialog(Form100Dss.this,SweetAlertDialog.NORMAL_TYPE)
    ...
    public void onBackPressed() {
        AlertDialog.Builder builder = new AlertDialog.Builder(Form100Dss.this);
    ...
    public void getArea(final Context context, final JSONObject details, final String whichArea){
        ...
        pDialog.setMessage("Please Wait...");
        pDialog.setCancelable(false);
        final Activity activity = Form100Dss.this;
        MUtil.showProgressDialog(pDialog);
...
//                                    final ArrayList<Area> areasReferral = Area.makeArrayList(response.getJSONArray("areas"));
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Log.e(MApplication.TAG, error.toString());
                        MUtil.hideProgressDialog(pDialog);
                        Crouton.makeText(Form100Dss.this, VolleyErrorHelper.getMessage(error, context), Style.ALERT).show();
                        try {
                            getLocalArea();
                        } catch (JSONException e) {
                            e.printStackTrace();
